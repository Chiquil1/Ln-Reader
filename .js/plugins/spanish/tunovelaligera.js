...
var TuNovelaLigera = /** @class */ (function () {
    ...
    TuNovelaLigera.prototype.sleep = function (_ms) {
    ...
    TuNovelaLigera.prototype.popularNovels = function (pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function (pageNo, _b) {
            var link, isFilterGenres, isFilterOrder, formData, result, loadedCheerio, novels;
            var _this = this;
            var _c, _d, _e;
            var 
            // showLatestNovels,
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        link = this.site;
                        isFilterGenres = ((_c = filters === null || filters === void 0 ? void 0 : filters.genres) === null || _c === void 0 ? void 0 : _c.value) != '';
                        isFilterOrder = ((_d = filters === null || filters === void 0 ? void 0 : filters.order) === null || _d === void 0 ? void 0 : _d.value) != 'rating';
                        link += isFilterOrder
                            ? "/novelas/?m_orderby=".concat((_e = filters === null || filters === void 0 ? void 0 : filters.order) === null || _e === void 0 ? void 0 : _e.value)
                        ...
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(link, isFilterOrder
                                ? {}
                                : {
                                    method: 'POST',
                                    body: formData,
    ...
    TuNovelaLigera.prototype.parseChapters = function (loadedCheerio) {
        var _this = this;
        var hasWpMangaItems = loadedCheerio("ul > li[class*='wp-manga'][class^='wp-manga']").length > 0;
        var chapters = [];
        loadedCheerio(hasWpMangaItems
            ? "ul > li[class*='wp-manga'][class^='wp-manga']"
            : "ul[id*='lcp_instance'] > li").each(function (_i, el) {
    ...
    TuNovelaLigera.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            var novelUrl, result, body, loadedCheerio, nameNovel, apiChapter, resultApi, bodyApi, chaptersApi, hasWpMangaItems, lastPage, novel, novelCover, cherioDefault, latestChapterEle, latestChapterUrl, latestChapterName;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        nameNovel = novelPath.split('/')[2];
                        apiChapter = "".concat(this.site, "/novelas/").concat(nameNovel);
                        return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(apiChapter, "/ajax/chapters/"), {
                                method: 'POST',
                            })];
                    case 3:
                        resultApi = _a.sent();
                        return [4 /*yield*/, resultApi.text()];
                    case 4:
                        bodyApi = _a.sent();
                        chaptersApi = (0, cheerio_1.load)(bodyApi);
                        hasWpMangaItems = chaptersApi("ul > li[class*='wp-manga'][class^='wp-manga']").length > 0;
                        lastPage = 1;
                        ...
                        novel.cover = (novelCover.attr('data-src') ||
                            novelCover.attr('src') ||
                            novelCover.attr('data-cfsrc') ||
                            defaultCover_1.defaultCover).trim();
                        ...
                        cherioDefault = hasWpMangaItems ? chaptersApi : loadedCheerio;
                        novel.chapters = this.parseChapters(cherioDefault);
                        if (!hasWpMangaItems) {
                            latestChapterEle = loadedCheerio("ul[id*='lcp_instance'] > li").first();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        pageUrl = this.site + novelPath + page;
    ...
    TuNovelaLigera.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var result, body, loadedCheerio, chapterText, paragraph, chapterHtml, tagsPermisive;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        body = _a.sent();
                        loadedCheerio = (0, cheerio_1.load)(body);
                        chapterText = loadedCheerio('div.entry-content_wrap:has(>p), div.entry-content_wrap div:has(>p)').first();
