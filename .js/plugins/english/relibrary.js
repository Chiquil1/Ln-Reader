...
var ReLibraryPlugin = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        loadedCheerio('.entry-content > ol > li').each(function (_i, el) {
                            ...
                            novel.path = new URL(novel.path, _this.site).pathname;
                            novels.push(novel);
                        });
                    ...
                    case 2:
                        ...
                        loadedCheerio('.entry-content > div.su-accordion').each(function (_i1, el) {
                            loadedCheerio(el)
                                ...
                                if (loadedCheerio(chap_el).text() === undefined || !chap_path)
                                    return;
                                chapters.push({
                                    name: loadedCheerio(chap_el).text(),
                                    path: new URL(chap_path, _this.site).pathname,
    ...
    ReLibraryPlugin.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var result, body, loadedCheerio, entryContent, pageLinkHr, prev, pageLink, hrAfterPageLink, next, temp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, entryContent.html() || ''];
                }
            });
        });
    };
                    ...
                    case 2:
                        ...
                        loadedCheerio('article article').each(function (_i, el) {
                            ...
                            if (href && e.find('a').text()) {
                                novels.push({
                                    name: e.find('h4').text(),
                                    path: new URL(href, _this.site).pathname,
