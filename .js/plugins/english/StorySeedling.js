...
var StorySeedlingPlugin = /** @class */ (function () {
    ...
    StorySeedlingPlugin.prototype.parseAgoDate = function (date) {
        //parseMadaraDate
    ...
    StorySeedlingPlugin.prototype.getNovels = function (pageNo_1) {
        return __awaiter(this, arguments, void 0, function (pageNo, searchTerm) {
            var body, loadedCheerio, postValue, data, response, novels;
            var _this = this;
            var _a;
            if (searchTerm === void 0) { searchTerm = ''; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + 'browse').then(function (r) { return r.text(); })];
                    case 1:
                        body = _b.sent();
                    ...
                    case 2:
                        response = (_b.sent());
                        novels = response.data.posts.map(function (element) { return ({
                            name: element.title,
    ...
    StorySeedlingPlugin.prototype.popularNovels = function (pageNo) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getNovels(pageNo)];
            });
        });
    };
    StorySeedlingPlugin.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            var $, novel, coverUrl, genres, rawStatus, map, summaryDiv, pTagSummary, chapters, xdata, listXdata, dataNovelId, dataNovelN, idMatch, novelId, chapterListing, formData, chaptersUrl, refererUrl, results;
            var _this = this;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        results = _b.sent();
                        if (results.data) {
                            results.data.forEach(function (chap) {
                                if (chap.url == null) {
                                    return;
                                }
                                var name = chap.title;
                                ...
                                chapters.push({
                                    ...
                                    releaseTime: _this.parseAgoDate(chap.date),
