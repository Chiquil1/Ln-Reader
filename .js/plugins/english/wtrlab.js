...
var WTRLAB = /** @class */ (function () {
            ...
            return __generator(this, function (_p) {
                switch (_p.label) {
                    ...
                    case 4:
                        ...
                        chapters = [];
                        if (!(rawId && slug && chapterCount > 0)) return [3 /*break*/, 9];
                        _p.label = 5;
                    case 5:
                        _p.trys.push([5, 7, , 8]);
    ...
    WTRLAB.prototype.fetchAllChapters = function (rawId, totalChapters, slug) {
        return __awaiter(this, void 0, void 0, function () {
            var allChapters, batchSize, start, end, response, data, chapters, batchChapters, error_2;
            var _this = this;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _d.label = 1;
                    case 1:
                        if (!(start <= totalChapters)) return [3 /*break*/, 7];
